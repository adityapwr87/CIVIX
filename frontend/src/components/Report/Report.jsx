...
function LocationMarker({ defaultLocation, onLocationSelect }) {
  ...
  useMap().on('click', (e) => {
    ...
    onLocationSelect([newPosition.lng, newPosition.lat]);
  });
  ...
  return (
    <div className="report-container">
      <div className="report-content">
        ...
        <p className="subtitle">Help improve your community by reporting local problems</p>
            ...
            <div className="form-group">
              ...
              {showMap && (
                <div className="map-container">
                  <MapContainer
                    center={defaultLocation || [18.5204, 73.8567]}
                    zoom={15}
                  ...
                  >
                    ...
                    />
                    <MapCenter center={defaultLocation} />
                  </MapContainer>
                </div>
              )}
            </div>
